<template>
  <div>
    <img @click="editCropper()" class="img-circle img-lg" title="点击上传头像" v-bind:src="options.img"/>
    <el-dialog :title="title" :visible.sync="open" @opened="modalOpened" append-to-body width="800px">
      <el-row>
      ...
      <el-row>
        ...
        <el-col :lg="{span: 2, offset: 6}" :md="2">
          <el-button @click="uploadImg()" size="small" type="primary">提 交</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
