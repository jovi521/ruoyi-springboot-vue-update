  ...
  <div class="app-container">
    <el-form :inline="true" :model="queryParams" label-width="68px" ref="queryForm" v-show="showSearch">
      ...
      <el-form-item label="任务组名" prop="jobGroup">
        <el-select clearable placeholder="请选择任务组名" size="small" v-model="queryParams.jobGroup">
          <el-option
            :key="dict.dictValue"
      ...
      <el-form-item label="任务状态" prop="status">
        <el-select clearable placeholder="请选择任务状态" size="small" v-model="queryParams.status">
          <el-option
            :key="dict.dictValue"
            :label="dict.dictLabel"
            :value="dict.dictValue"
    ...
    <el-table :data="jobList" @selection-change="handleSelectionChange" v-loading="loading">
    ...
    <el-dialog :visible.sync="openView" append-to-body title="任务详细" width="700px">
      <el-form :model="form" label-width="120px" ref="form" size="mini">
        <el-row>
          <el-col :span="12">
